...
export function Profile() {
    return (
        <>
            <Nav />
            <div className="page">
                <div className="nav-theme px-4 py-2 rounded-lg mx-auto my-auto">
                    ...
                    <div className="flex flex-col relative mb-12">
                        <div 
                            ...
                            className="h-32 w-auto rounded-md bg-cover bg-no-repeat bg-center"
                        ></div>
                        <div className="absolute -bottom-8 left-8">
                            <img className="avtaar h-16 w-auto border border-gray-100 bg-green-200" src="https://cdn.pixabay.com/photo/2015/03/04/22/35/head-659651_960_720.png" alt="user" />
                        </div>
                    </div>
                    <div className="text-right">
                        ...
                        <button className="my-1 border rounded-xl outline-none px-6 py-2 logout">LogOut</button>
                    </div>
                </div>
            </div>
        </>
